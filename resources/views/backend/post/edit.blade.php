                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                ...
                                <div class="form-group">
                                    <form action="{{route('admin.update',['id'=>$posts->id])}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="card-body">
                                            <div class="form-group">
...
{{--                                            </select>--}}
                                            <div class="form-check">
                                                <label class="form-check-label" for="InputFile" > Hiển thị lên trang nổi bật  </label>
                                                <br>
                                                <input type="radio" class="form-check-input" id="r2" name="r2" {{$posts->highlight==1?'checked':''}} value="1">có
                                                <br>
                                                <input type="radio" class="form-check-input" id="r2" name="r2" {{$posts->highlight==0?'checked':''}} value="0">không
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="InputFile" > Hiển thị lên màn hình  </label>
                                                <br>
                                                <input type="radio" class="form-check-input" id="r1" name="r1" {{$posts->status==1?'checked':''}} value="1">có
                                                <br>
                                                <input type="radio" class="form-check-input" id="r1" name="r1" {{$posts->status==0?'checked':''}} value="0">không
                                            </div>
